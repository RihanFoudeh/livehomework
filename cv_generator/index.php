...
<body>
    ...
    <div class="container my-5">
        ...
        <form method="GET" action="./create.php" class="w-25">
...
<div class="d-flex justify-content-end  ">
                <button id="toPersonalStatement" class="btn btn-outline-success w-25 "> > ></button>
                </div>
            </section>
            ...
            <section id="personalStatement">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <button id="backBasicInfo" class="btn btn-outline-danger">< <</button>
                    <button id="toWorkExperience" class="btn btn-outline-success">> ></button>
                </div>
            </section>
            ...
            <section id="workExperience">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <button id="backPersonalStatement" class="btn btn-outline-danger">< <</button>
                    <button id="toEducation" class="btn btn-outline-success">> ></button>
                </div>
            </section>
            ...
            <section id="education">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <button id="backWorkExperience" class="btn btn-outline-danger">< <</button>
                    <button id="toSkills" class="btn btn-outline-success">> ></button>
                </div>
            </section>
            ...
            <section id="skills">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <button id="backEducation" class="btn btn-outline-danger">< <</button>
